  ...
  return (
    <div>
      ...
      <header className="site-header section-padding-img site-header-image">
        ...
        <img
          src="website/images/header/businesspeople-meeting-office-working.jpg"
          ...
          <div className="row">
            ...
            <div className="col-lg-4 mb-4 col-12">
              <div className="team-thumb d-flex align-items-center">
                <img
                  src="website/images/people/senior-man-wearing-white-face-mask-covid-19-campaign-with-design-space.jpeg"
            ...
            <div className="col-lg-4 mb-4 col-12">
              <div className="team-thumb d-flex align-items-center">
                <img
                  src="website/images/people/portrait-british-woman.jpeg"
                  class="img-fluid custom-circle-image team-image me-4"
                  alt=""
                />
            ...
            <div className="col-lg-4 mb-lg-0 mb-4 col-12">
              <div className="team-thumb d-flex align-items-center">
                <img
                  src="website/images/people/beautiful-woman-face-portrait-brown-background.jpeg"
                  class="img-fluid custom-circle-image team-image me-4"
                  alt=""
                />
            ...
            <div className="col-lg-9 mx-auto col-11">
              ...
              <div className="slick-testimonial">
                ...
                <div className="slick-testimonial-caption">
                  ...
                  <div className="slick-testimonial-client d-flex align-items-center mt-4">
                    <img
                      src="website/images/people/woman-wearing-mask-face-closeup-covid-19-green-background.jpeg"
                      class="img-fluid custom-circle-image me-3"
                      alt=""
                    />
